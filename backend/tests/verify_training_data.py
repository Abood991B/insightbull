...
print(f"Total Reddit samples in database: {total}")
...
cursor.execute('''
    ...
    LIMIT 10
''')
print("\nSample Reddit Posts Used for Training (first 10):")
print("=" * 80)
...
print("No mock or sample data was used - these are actual Reddit posts")
