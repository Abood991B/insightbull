...
const UserLayout = ({ children }: UserLayoutProps) => {
  ...
  const navigation = [
    ...
    { name: "Sentiment vs Price", href: "/sentiment-vs-price", icon: LayoutDashboard },
    { name: "Correlation Analysis", href: "/correlation", icon: LayoutDashboard },
    { name: "Sentiment Trends", href: "/trends", icon: LayoutDashboard },
      ...
      <div className={`fixed left-0 top-0 h-full bg-white shadow-lg transition-all duration-300 z-40 ${
        ...
        <div className="p-4 border-b">
          <div className="flex items-center justify-between">
            <h1 className={`font-bold text-xl text-blue-600 transition-opacity ${
